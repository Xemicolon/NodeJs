  ...
  switch (req.url) {
    ...
    case "/message":
      if (req.method === "POST") {
        ...
        req.on("end", () => {
          res.end(
            "<h1 style='text-align: center; width: 50%; margin: 0 auto'>Your messages has been submitted and saved to a message.txt file and same location where your server is on your machine. </h1>"
          );
        });
      }
  }
